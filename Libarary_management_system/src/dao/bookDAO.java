...
public class bookDAO implements dao.DAOInterface<book> {
    ...
    public int insert(book book) {
        ...
        try (Connection conn = JDBCUtil.getConnection();
            ...
            System.out.println("Có " + KetQua + " dòng đã bị thay đổi.");
        ...
        try (Connection conn = JDBCUtil.getConnection();
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    book bookObj = new book(bookID, categoryID, availability, remainingBooks, language, edition,
                            bookAuthor, bookTitle, bookPublisher, quantity, categoryName);
                    bookList.add(bookObj);
                }
            }
